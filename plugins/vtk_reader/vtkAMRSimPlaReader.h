...
public:
    ...
    // Description:
    // Register/Serialize whether m_data should be converted to CGS
...
protected:
    ...
    // Description:
    // Given an array GetPrefix of the form "array[idx]" this method
    ...
    // Description:
    // Given the variable GetPrefix, return the conversion factor used to convert_database_r
