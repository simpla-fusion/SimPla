...
struct Mesh<CoordinateSystem, tags::structured> :

		public Block<geometry::traits::dimension<CoordinateSystem>::value>,

		public std::enable_shared_from_this<
				Mesh<CoordinateSystem, simpla::tags::structured> >
{
	typedef CoordinateSystem cs_type;
	typedef Block<geometry::traits::dimension<CoordinateSystem>::value> topology_type;
