...
namespace simpla
{
template<int NDIMS, int LEVEL> struct Block;
...
struct BlockLayout
{
	...
	typedef Block<NDIMS, LEVEL> block;
	typedef BlockLayout<NDIMS, LEVEL + 1> coarse_block;
	typedef BlockLayout<NDIMS, LEVEL - 1> fine_block;


	typedef BlockLayout<NDIMS, LEVEL> block_layout;
	typedef BlockLayout<NDIMS, LEVEL + 1> coarse_block_layout;
	typedef BlockLayout<NDIMS, LEVEL - 1> fine_block_layout;
