...
struct BlockLayout
{
    ...
    BlockLayout(const block_type &inner_box) :
            m_outer_box_(inner_box),
            m_inner_box_(inner_box)
    { }

    BlockLayout(const BlockLayout &other) :
            m_outer_box_(other.m_outer_box_),
            m_inner_box_(other.m_inner_box_)
    { }


    BlockLayout(BlockLayout &other, tags::split) :
            BlockLayout(other)
    {
        // TODO split
    };
    ...
    id_tag_type add(index_tuple const &dimension)
    {

    }


    id_tag_type split(index_tuple const &dim)
    {
