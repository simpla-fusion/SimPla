...
struct MeshID
{
	...
	typedef range<this_type> range_type;
...
//	}
	...
	static constexpr id_type m_iform_to_num_of_ele_in_cell_[] = {
...
template<size_t TAGS> constexpr int MeshID<TAGS>::ndims;
template<size_t TAGS> constexpr int MeshID<TAGS>::MESH_RESOLUTION;
template<size_t TAGS> constexpr Real MeshID<TAGS>::EPSILON;

template<size_t TAGS> constexpr int MeshID<TAGS>::FULL_DIGITS;


template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::OVERFLOW_FLAG;
template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::ID_ZERO;
template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::INDEX_ZERO;
template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::ID_DIGITS;
template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::ID_MASK;
template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::_DK;
template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::_DJ;
template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::_DI;
template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::_DA;


template<size_t TAGS> constexpr int MeshID<TAGS>::m_id_to_index_[];

template<size_t TAGS> constexpr int MeshID<TAGS>::m_id_to_iform_[];

template<size_t TAGS> constexpr int MeshID<TAGS>::m_id_to_num_of_ele_in_cell_[];
template<size_t TAGS> constexpr int MeshID<TAGS>::m_iform_to_num_of_ele_in_cell_[];


template<size_t TAGS> constexpr int MeshID<TAGS>::m_adjoint_num_[4][8];


template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::m_id_to_shift_[];
template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::m_iform_to_shift_[];

template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type MeshID<TAGS>::m_sub_index_to_id_[4][3];


template<size_t TAGS> constexpr typename MeshID<TAGS>::id_type
		MeshID<TAGS>::m_adjoint_matrix_[4/* to iform*/][8/* node id*/][MAX_NUM_OF_CELL/*id shift*/];

template<size_t TAGS> constexpr typename MeshID<TAGS>::point_type MeshID<TAGS>::m_id_to_coordinates_shift_[];
