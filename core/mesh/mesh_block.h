...
#ifndef SIMPLA_MESH_BLOCK_H
#define SIMPLA_MESH_BLOCK_H
...
template<typename ...> struct MeshBlock;

template<int NDIMS>
struct MeshBlock<NDIMS> : public MeshIDs_<4>
{
...
public:
	...
	typedef MeshBlock<NDIMS> this_type;
...
struct point_type<MeshBlock<TAG> >
{
