...
{
template<typename T>
struct iform<Field<Expression<tags::HodgeStar, T> > > : public std::integral_constant<
		int, traits::rank<T>::value - traits::iform<T>::value>
{
};

template<typename T0, typename T1>
struct iform<Field<Expression<tags::InteriorProduct, T0, T1> > > : public std::integral_constant<
...
template<typename T>
struct iform<Field<Expression<tags::ExteriorDerivative, T> > > : public std::integral_constant<
		int, traits::iform<T>::value + 1>
{
};

template<typename T>
struct iform<Field<Expression<tags::CodifferentialDerivative, T> > > : public std::integral_constant<
		int, traits::iform<T>::value - 1>
{
};

template<typename T0, typename T1>
struct iform<Field<Expression<tags::Wedge, T0, T1> > > : public std::integral_constant<
		int, iform<T0>::value + iform<T1>::value>
{
};

template<size_t I, typename T1>
struct iform<Field<Expression<tags::MapTo,  //
...
template<typename T>
struct value_type<Field<Expression<tags::ExteriorDerivative, T> > >
{
	typedef result_of_t<
...
template<typename T>
struct value_type<Field<Expression<tags::CodifferentialDerivative, T> > >
{
	typedef result_of_t<
			simpla::_impl::multiplies(scalar_type_t<mesh_type_t<T>>,
					value_type_t<T>)> type;
...
template<typename T0, typename T1>
struct value_type<Field<Expression<tags::Wedge, T0, T1> > >
{
...
template<typename T0, typename T1>
struct value_type<Field<Expression<tags::InteriorProduct, T0, T1> > >
{
...
template<typename T0, typename T1>
struct value_type<Field<Expression<tags::MapTo, T0, T1> > >
{
...
template<size_t I, typename T1>
struct domain_type<
		Field<Expression<tags::MapTo, std::integral_constant<int, I>, T1> > >
{
...
DECL_RET_TYPE(( Field<Expression<tags::HodgeStar , T > >(f)))

template<typename TL, typename TR>
inline auto wedge(TL const & l, TR const & r)
DECL_RET_TYPE((Field< Expression<tags::Wedge , TL, TR> >(l, r)))

template<typename TL, typename TR>
inline auto interior_product(TL const & l, TR const & r)
DECL_RET_TYPE((Field< Expression<tags::InteriorProduct , TL, TR > > (l, r)))
...
inline Field<Expression<tags::MapTo, std::integral_constant<int, I>, T> > map_to(
		T const & f)
{
	return std::move(
			(Field<Expression<tags::MapTo, std::integral_constant<int, I>, T> >(
...
DECL_RET_TYPE(( Field< Expression<tags::ExteriorDerivative , T > >(f)))

template<typename T>
inline auto codifferential_derivative(T const & f)
DECL_RET_TYPE((Field<Expression< tags::CodifferentialDerivative , T > >(f)))
...
DECL_RET_TYPE(( Field<Expression< tags:: ExteriorDerivative,
				std::integral_constant<int, I>, T > >(
						std::integral_constant<int, I>(),f)))
;
template<int I, typename T>
inline auto p_codifferential_derivative(T const & f)
DECL_RET_TYPE((Field< Expression<tags:: CodifferentialDerivative ,
				std::integral_constant<int, I>, T > >(
						std::integral_constant<int, I>(),f)))
;
