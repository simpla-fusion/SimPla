...
template<typename P, typename M, typename ...Policies>
Particle<P, M, Policies...>::Particle(M const &m) : m_mesh_(m) { }
...
void Particle<P, M, Policies...>::load(TDict const &dict) { engine_type::load(dict); }
...
template<typename P, typename M, typename ...Policies>
template<typename TField>
void Particle<P, M, Policies...>::integral(id_type const &s, TField *J) const
{
...
template<typename P, typename M, typename ...Policies>
template<typename TField>
void Particle<P, M, Policies...>::integral(range_type const &r, TField *J) const
{
...
template<typename P, typename M, typename ...Policies>
template<typename TField>
void Particle<P, M, Policies...>::integral(TField *J) const
{
...
template<typename P, typename M, typename ...Policies>
template<typename ...Args>
void Particle<P, M, Policies...>::push(id_type const &s, Args &&...args)
{
...
template<typename P, typename M, typename ...Policies>
template<typename ...Args>
void Particle<P, M, Policies...>::push(range_type const &r, Args &&...args)
{
    // TODO cache args, Base on s or r
    for (auto const &s:r) { push(s, std::forward<Args>(args)...); }
};

template<typename P, typename M, typename ...Policies> template<typename ...Args>
void Particle<P, M, Policies...>::push(Args &&...args)
{
...
template<typename P, typename M, typename ...Policies>
size_t Particle<P, M, Policies...>::size(range_type const &r, container_type const &c) const
{
...
template<typename P, typename M, typename ...Policies>
size_t Particle<P, M, Policies...>::size(range_type const &r) const
{
    return size(r, *m_data_);
}

template<typename P, typename M, typename ...Policies>
size_t Particle<P, M, Policies...>::size() const
{
...
template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::erase(range_type const &r)
{
...
OutputIterator Particle<P, M, Policies...>::copy(id_type s, OutputIterator out_it) const
{
...
template<typename P, typename M, typename ...Policies>
template<typename OutputIterator>
OutputIterator Particle<P, M, Policies...>::copy(range_type const &r, OutputIterator out_it) const
{
    //TODO need optimize
...
template<typename P, typename M, typename ...Policies>
template<typename OutputIterator>
OutputIterator Particle<P, M, Policies...>::copy(OutputIterator out_it) const
{
...
template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::merge(id_type const &s, container_type *buffer)
{
...
template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::merge(buffer_type *buffer, container_type *other)
{
...
template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::merge(range_type const &r, container_type *other)
{
...
template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::merge(container_type *other)
{
...
template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::sync(container_type const &buffer, parallel::DistributedObject *dist_obj,
                                       bool update_ghost)
{
...
template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::rehash(id_type const &key, container_type *other)
{
    typename container_type::accessor acc0;
...
template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::rehash(range_type const &r, container_type *buffer)
{
    for (auto const &s:r) { rehash(s, buffer); }
}

template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::rehash()
{
...
template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::push_back(value_type const &p)
{
    typename container_type::accessor acc;
...
void Particle<P, M, Policies...>::push_back(InputIt const &b, InputIt const &e)
{
...
template<typename P, typename M, typename ...Policies>
data_model::DataSet Particle<P, M, Policies...>::data_set() const
{
...
template<typename P, typename M, typename ...Policies>
void Particle<P, M, Policies...>::data_set(data_model::DataSet const &ds)
{
...
void Particle<P, M, Policies...>::generator(id_type s, TGen &gen, size_t pic, Args &&...args)
{
...
template<typename P, typename M, typename ...Policies>
template<typename TGen, typename ...Args>
void Particle<P, M, Policies...>::generator(const range_type &r, TGen &gen, size_t pic, Args &&...args)
{
...
template<typename P, typename M, typename ...Policies>
template<typename TGen, typename ...Args>
void Particle<P, M, Policies...>::generator(TGen &gen, size_t pic, Args &&...args)
{
...
void Particle<P, M, Policies...>::remove_if(TRange const &r, Predicate const &pred)
{
...
void Particle<P, M, Policies...>::accept(TConstraint const &constraint, TFun const &fun)
{
    container_type buffer;
    parallel::parallel_for(
            constraint.range(),
