...
foreach(_expectedTarget TKCDF TKLCAF TKCAF TKBinL TKXmlL TKBin TKXml TKStdL TKStd FWOSPlugin TKTObj TKBinTObj TKXmlTObj TKVCAF)
...
set_target_properties(FWOSPlugin PROPERTIES
  INTERFACE_LINK_LIBRARIES "TKernel;TKCDF"
)
