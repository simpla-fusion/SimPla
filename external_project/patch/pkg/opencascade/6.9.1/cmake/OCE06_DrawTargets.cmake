...
foreach(_expectedTarget TKDraw TKTopTest TKViewerTest TKXSDRAW TKDCAF TKXDEDRAW TKTObjDRAW TKQADraw)
...
file(GLOB CONFIG_FILES "${_DIR}/OCE06_DrawTargets-*.cmake")
...
foreach(target ${_IMPORT_CHECK_TARGETS} )
  foreach(file ${_IMPORT_CHECK_FILES_FOR_${target}} )
   ...
   \"${file}\"
but this file does not exist.  Possible rens include:
...
# Make sure the targets which have been exported inme other 
# export set exist.
unset(${CMAKE_FIND_PACKAGE_NAME}_NOT_FOUND_MESSAGE_targets)
foreach(_target "TKernel" "TKG2d" "TKGeomBase" "TKG3d" "TKMath" "TKBRep" "TKGeomAlgo" "TKTopAlgo" "TKMesh" "TKService" "TKHLR" "TKBO" "TKV3d" "TKFillet" "TKPrim" "TKBool" "TKOffset" "TKFeat" "TKNIS" "TKShHealing" "TKVoxel" "TKOpenGl" "TKXSBase" "TKMeshVS" "TKSTEPBase" "TKSTEP" "TKIGES" "TKSTL" "TKVRML" "TKCAF" "TKCDF" "TKLCAF" "TKXCAF" "TKXDEIGES" "TKXDESTEP" "TKTObj" "PTKernel" "TKShapeSchema" "TKPShape" )
