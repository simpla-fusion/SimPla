 ...
 *	 ------------------------------------|----------
 * 	 `RangeHolder split_from_this(...)`       | Split *this into two pieces, that use *this as _root_. One replaces *this and  another one is returned.
 * 	 `const_holder root()`                     | Return 'root container' that reference to whole m_data. If `*this` is never split , return `*this`
 *
 * ## Description
 *
 *  @}
