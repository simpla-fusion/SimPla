...
size_type DataNodeXDMF::Set(std::string const& url, const std::shared_ptr<DataNode>& v) { return 0; }
size_type DataNodeXDMF::Add(std::string const& url, const std::shared_ptr<DataNode>& v) { return 0; }
...
size_type DataNodeXDMF::Set(index_type s, const std::shared_ptr<DataNode>& v) { return 0; }
size_type DataNodeXDMF::Add(index_type s, const std::shared_ptr<DataNode>& v) { return 0; }
