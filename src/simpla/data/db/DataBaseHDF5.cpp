...
int DataBaseHDF5::Disconnect() { return SP_SUCCESS; }
int DataBaseHDF5::Flush() { return SP_SUCCESS; }
bool DataBaseHDF5::isNull() const { return true; }

std::shared_ptr<DataNode> DataBaseHDF5::Root() { return DataNode::New(); }
...
//        char buffer[num + 1];
//        H5Lget_name_by_idx(m_pimpl_->m_g_id_, ".", H5_INDEX_NAME, H5_ITER_INC, i, buffer, static_cast<size_t>(num +
//        1),
//                           H5P_DEFAULT);
