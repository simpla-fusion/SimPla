...
#ifndef SIMPLA_toolbox_PROPERTIES_H_
#define SIMPLA_toolbox_PROPERTIES_H_
...
//   template<typename T>   void operator()(std::string const &key, T &&v) { set_value(key, std::forward<T>(v)); }
//
