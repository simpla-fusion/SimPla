...
#define FIXME  logger::Logger(logger::LOG_VERBOSE)<< FILE_LINE_STAMP<<   "Some problems at here, please recheck! "<<std::endl
...
#define CHECK_BIT(_MSG_)  std::cout<<std::setfill(' ')<<std::setw(10) <<__STRING(_MSG_)<<" = 0b"<< simpla::logger::ShowBit( _MSG_)  << std::endl
