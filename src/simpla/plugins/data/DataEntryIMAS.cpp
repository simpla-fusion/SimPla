...
struct DataEntryIMAS : public Entry {
    SP_DATA_ENTITY_HEAD(Entry, DataEntryIMAS, imas)
...
SP_REGISTER_CREATOR(Entry, DataEntryIMAS);
DataEntryIMAS::DataEntryIMAS(Entry::eNodeType e_type) : base_type(e_type){};
...
std::shared_ptr<Entry> DataEntryIMAS::CreateNode(Entry::eNodeType e_type) const { return nullptr; }

size_type DataEntryIMAS::Set(std::string const& uri, const std::shared_ptr<Entry>& v) { return 0; }
size_type DataEntryIMAS::Set(index_type s, std::shared_ptr<Entry> const& v) { return 0; }
size_type DataEntryIMAS::Add(std::string const& uri, const std::shared_ptr<Entry>& v) { return 0; }
size_type DataEntryIMAS::Add(index_type s, std::shared_ptr<Entry> const& v) { return 0; }
size_type DataEntryIMAS::Delete(std::string const& s) { return 0; }
size_type DataEntryIMAS::Delete(index_type s) { return 0; }
std::shared_ptr<Entry> DataEntryIMAS::Get(index_type s) { return nullptr; }
std::shared_ptr<const Entry> DataEntryIMAS::Get(index_type s) const { return nullptr; }
std::shared_ptr<Entry> DataEntryIMAS::Get(std::string const& uri) { return 0; }
std::shared_ptr<const Entry> DataEntryIMAS::Get(std::string const& uri) const { return 0; }
void DataEntryIMAS::Foreach(
    std::function<void(std::string const&, std::shared_ptr<const Entry> const&)> const& f) const {
    UNIMPLEMENTED;
}
void DataEntryIMAS::Foreach(std::function<void(std::string const&, std::shared_ptr<Entry> const&)> const& f) {
    UNIMPLEMENTED;
}
