...
std::tuple<nTuple<T, N...>, nTuple<T, N...>> expand_gw(std::tuple<nTuple<T, N...>, nTuple<T, N...>> const &b,
                                                       nTuple<T, N...> const &gw) {
...
template <typename T>
using Vector3 = nTuple<typename std::make_signed<T>::type, 3>;
template <typename T>
using Box3 = std::tuple<Point3<T>, Point3<T>>;
...
template <typename T>
constexpr inline bool is_inside(Point3<T> const &p, Box3<T> const &b) {
