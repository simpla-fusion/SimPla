...
void Face::Deserialize(std::shared_ptr<simpla::data::DataEntry> const &cfg) { base_type::Deserialize(cfg); };
std::shared_ptr<simpla::data::DataEntry> Face::Serialize() const { return base_type::Serialize(); };
}  // namespace geometry
}  // namespace simpla