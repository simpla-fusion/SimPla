...
Handle(Geom_Curve) make_geo_curve(Axis const &g_axis, std::shared_ptr<const GeoEntity> const &curve) {
...
Handle(Geom_Surface) make_geo_surface(Axis const &g_axis, std::shared_ptr<const GeoEntity> const &surface) {
