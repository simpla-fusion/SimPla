...
//
//	static inline coordinate_type PopPatch(segment_type const& s)
//	{
//		return geometry::get<Dimension>(simpla::traits::PopPatch<0>(s));
//	}
//
//	static inline void SetValue(segment_type& s, coordinate_type const& entity)
//	{
//		geometry::SetValue<Dimension>(simpla::traits::PopPatch<0>(s), entity);
//	}
//};
//
//template<typename CS, std::size_t Dimension>
...
//	static inline coordinate_type PopPatch(segment_type const& s)
//	{
//		return geometry::get<Dimension>(simpla::traits::PopPatch<1>(s));
//	}
//
//	static inline void SetValue(segment_type& s, coordinate_type const& entity)
//	{
//		geometry::SetValue<Dimension>(simpla::traits::PopPatch<1>(s), entity);
//	}
//};
