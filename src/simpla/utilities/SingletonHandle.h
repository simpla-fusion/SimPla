...
class SingletonHandle {
    ...
    void Initialize(std::shared_ptr<data::DataEntry> const &d = nullptr);
    ...
    void GeoEngineHolder::Initialize(std::shared_ptr<data::DataEntry> const &d) { m_engine_ = GeoEngine::New(d); }
