...
struct type_cast {
    static constexpr TDesc eval(TSrc const &v) { return static_cast<TDesc>(v); }
};
...
struct type_cast<std::string, std::string> {
    static std::string const &eval(std::string const &v) { return v; }
};

template <typename TSrc>
struct type_cast<TSrc, TSrc> {
    static TSrc const &eval(TSrc const &v) { return v; }
};
}  // namespace traits
...
TDest from_string(std::string const &v) {
    return traits::type_cast<std::string, TDest>::eval(v);
}
...
template <typename TSrc>
std::string string_cast(TSrc const &v) {
    return traits::type_cast<TSrc, std::string>::eval(v);
}
}  // namespace simpla
