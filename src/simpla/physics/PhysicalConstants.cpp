...
namespace simpla {
PhysicalConstants::PhysicalConstants(std::string type) : type_(type) { SetBaseUnit(type_); }
...
std::ostream &operator<<(std::ostream &os, PhysicalConstants const &self) { return self.save(os); }
...
void PhysicalConstants::SetBaseUnit(std::string const &type, double pm, double ps, double pkg, double pC, double pK,
    ...
    q_["permittivity of free space"] =
        1.0 / (q_["speed of light"] * q_["speed of light"] * q_["permeability of free space"]); /*exact*/
...
std::ostream &PhysicalConstants::print(std::ostream &os) const {
    os << "[Units] " << type_ << " ~ SI" << std::endl
       ...
       << std::setw(40) << "1 [electric charge unit] = " << 1.0 / (*this)["C"] << "[C]" << std::endl
       << std::setw(40) << "1 [temperature unit] = " << 1.0 / (*this)["K"] << "[K]" << std::endl
       << std::setw(40) << "1 [amount of substance] = " << 1.0 / (*this)["mol"] << "[mole]" << std::endl
       << "Physical constants:" << std::endl
       << std::setw(40) << "permeability of free space, mu = " << (*this)["permeability of free space"] << std::endl
       << std::setw(40) << "permittivity of free space, epsilon = " << (*this)["permittivity of free space"]
       << std::endl
       << std::setw(40) << "speed of light, c = " << (*this)["speed of light"] << std::endl
       << std::setw(40) << "elementary charge, e = " << (*this)["elementary charge"] << std::endl
       << std::setw(40) << "electron mass, m_e = " << (*this)["electron mass"] << std::endl
       << std::setw(40) << "proton mass,m_p = " << (*this)["proton mass"] << std::endl;
