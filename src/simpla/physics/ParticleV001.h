...
//        Clone(r0, reinterpret_cast< value_type *>( ds.GetDataBlock.Get()));
    }
    return std::move(ds);
};
...
//OutputIT
//Particle<P, M, V001>::Clone(range_type const &r, OutputIT out_it) const
//{
//    //TODO need optimize
//    for (auto const &s:r) { out_it = Clone(s, out_it); }
//    return out_it;
//}
...
//template<typename P, typename M> void
//Particle<P, M, V001>::Connect(mesh_id_type const &s, value_type const &v) { Set(s, &v, &v + 1); }
//
//
