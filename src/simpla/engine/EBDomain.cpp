...
//};
//
// std::shared_ptr<UnorderedRange<EntityId>> make_range(tbb::concurrent_unordered_set<EntityId, EntityIdHasher> const
// &t) {
...
//}
//
// void UpdateRanges(engine::MeshBase *m_domain_, std::string const &prefix, Array<int, ZSFC<3>> const &vertex_tags);
//
// void UpdateRanges(engine::MeshBase *m_domain_, std::string const &prefix, Array<int, ZSFC<3>> const &vertex_tags) {
//    /**
//    *\verbatim
...
//    */
//
//    //    Array<int, ZSFC<3>> volume_tags{nullptr, m_domain_->GetBoundingIndexBox(0b111)};
//    //
...
//
//    ZSFC<3>(geometry::Expand(m_domain_->GetBoundingIndexBox(0b111), index_tuple{1, 1, 1}))
//        .Foreach(  //
...
//
//    m_domain_->GetRange(prefix + "_BODY_0").append(make_range(VERTEX_body));
//    m_domain_->GetRange(prefix + "_BODY_1").append(make_range(EDGE_body));
//    m_domain_->GetRange(prefix + "_BODY_2").append(make_range(FACE_body));
//    m_domain_->GetRange(prefix + "_BODY_3").append(make_range(VOLUME_body));
//
//    m_domain_->GetRange(prefix + "_BOUNDARY_0").append(make_range(VERTEX_boundary));
//    m_domain_->GetRange(prefix + "_BOUNDARY_3").append(make_range(VOLUME_boundary));
//
//    m_domain_->GetRange(prefix + "_BOUNDARY_1").append(make_range(EDGE_boundary));
//    m_domain_->GetRange(prefix + "_BOUNDARY_2").append(make_range(FACE_boundary));
//
//    m_domain_->GetRange(prefix + "_CUT_BOUNDARY_1").append(make_range(EDGE_CUT_boundary));
//    m_domain_->GetRange(prefix + "_CUT_BOUNDARY_2").append(make_range(FACE_CUT_boundary));
//}
