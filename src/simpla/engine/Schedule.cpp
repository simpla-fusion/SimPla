...
std::shared_ptr<data::DataTable> Schedule::Pack() const {
...
void Schedule::Unpack(const std::shared_ptr<data::DataTable> &cfg) {
...
void Schedule::Synchronize() {
    ...
    //            &dest_p)
    //            //            {
    //            //                auto dest_data = d_it->cast_as<data::DataTable>().Pack(key);
