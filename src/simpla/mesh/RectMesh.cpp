...
//namespace mesh {
//
//RectMesh::RectMesh() : m_ndims_(0) {}
//
//RectMesh::RectMesh(int ndims, index_type const* lo, index_type const* up, Real const* dx, Real const* xlo)
//    : m_ndims_(ndims),
...
//}
//
//void RectMesh::InitializeConditionPatch() {
//    ASSERT(m_ndims_ <= 3);
//
...
//std::shared_ptr<RectMesh> RectMesh::create(int inc_level, const index_type* lo, const index_type* hi) const {
//    auto res = std::make_shared<RectMesh>();
//    if (inc_level >= 0) {
...
////    res->InitializeConditionPatch();
//    return res;
//}
//
//std::shared_ptr<RectMesh> RectMesh::intersection(index_box_type const& other_box, int inc_level) {
