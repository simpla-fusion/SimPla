...
/**
 * The SAMRAIWorkerHyperbolic class provides routines for a sample application code that
...
public:
    /**
     * The constructor for SAMRAIWorkerHyperbolic sets default parameters for the linear
