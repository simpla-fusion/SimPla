...
void SAMRAIWorkerHyperbolic::registerModelVariables(
...
void SAMRAIWorkerHyperbolic::registerVisItDataWriter(
...
void SAMRAIWorkerHyperbolic::printClassData(
        ostream &os) const
{
    int j, k;

    os << "\nSAMRAIWorkerHyperbolic::printClassData..." << endl;
 ...
 *************************************************************************
 */
void SAMRAIWorkerHyperbolic::getFromInput(
...
#if (TESTING == 1)
        if (num_bad_values > 0) {
         tbox::perr << "\nSAMRAIWorkerHyperbolic Boundary Test FAILED: \n"
                    << "     " << num_bad_values
...
void
SAMRAIWorkerHyperbolic::checkUserTagData(
        hier::Patch &patch,
...
void
SAMRAIWorkerHyperbolic::checkNewPatchTagData(
        hier::Patch &patch,
        const int tag_index) const
{
    boost::shared_ptr<pdat::CellData<int> > tags(
