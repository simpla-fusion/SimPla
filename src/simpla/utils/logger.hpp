...
#define CHANGE_INTERFACE(_MSG_)                                                                           \
    simpla::logger::Logger(simpla::logger::LOG_WARNING)                                                   \
        << "[" << __FILE__ << ":" << __LINE__ << ":" << (__PRETTY_FUNCTION__) << "]:" << "The function [" \
        << __PRETTY_FUNCTION__ << "] is obsolete. Please use [" << _MSG_ << "] inside."
...
#define NOTHING_TODO                                    \
    simpla::logger::Logger(simpla::logger::LOG_VERBOSE) \
        << "[" << __FILE__ << ":" << __LINE__ << ":" << (__PRETTY_FUNCTION__) << "]:" << "oh....... NOTHING TODO!"
...
#define VERBOSE simpla::logger::Logger(simpla::logger::LOG_VERBOSE) << FILE_LINE_STAMP
...
//
// #define THROW_EXCEPTION_BAD_ALLOC(_SIZE_, _error_)
// simpla::logger::Logger(simpla::logger::LOG_ERROR)<<__FILE__<<"["<<__LINE__<<"]: "<< "Can not Serialize enough memory!
// [ "  \
...
#define FE_CMD(_CMD_)                                                                            \
    _Pragma("STDC_FENV_ACCESS = on") {                                                           \
        ...
        if (std::fetestexcept(FE_ALL_EXCEPT) & FE_INVALID) {                                     \
            WARNING << " FE_INVALID is raised! " << " [" << __STRING(_CMD_) << "]" << std::endl; \
        }                                                                                        \
