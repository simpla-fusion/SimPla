...
typename Mesh<EuclideanGeometry<OcForest<Real>>> ::coordinates_type,

typename Mesh<EuclideanGeometry<OcForest<Real>>> ::coordinates_type,

nTuple<Mesh<EuclideanGeometry<OcForest<Real>>> ::NDIMS, size_t>
...
public:
	...
	nTuple<3, Real> K =
	{	2.0 * PI, 3.0 * PI, 4.0 * PI}; // @NOTE must   k = n TWOPI, period condition
...
class TestDiffCalculusKz: public testing::TestWithParam<

std::tuple<

typename Mesh<EuclideanGeometry<OcForest<std::complex<Real>>> > ::coordinates_type,

typename Mesh<EuclideanGeometry<OcForest<std::complex<Real>>>> ::coordinates_type,

nTuple<Mesh<EuclideanGeometry<OcForest<std::complex<Real>>>> ::NDIMS, size_t>
...
public:
	...
	typedef Mesh<EuclideanGeometry<OcForest<std::complex<Real>>>> mesh_type;
	typedef Real value_type;
	typedef mesh_type::iterator iterator;
	typedef mesh_type::coordinates_type coordinates_type;
	typedef mesh_type::scalar_type scalar_type;
	...
	typedef Field<mesh_type, VERTEX, scalar_type> TCZeroForm;
	typedef Field<mesh_type, EDGE, scalar_type> TCOneForm;
	typedef Field<mesh_type, FACE, scalar_type> TCTwoForm;
	typedef Field<mesh_type, VOLUME, scalar_type> TCThreeForm;
...
TEST_P(TestDiffCalculusKz, grad0)
{
...
TEST_P(TestDiffCalculusKz, grad3)
{
...
TEST_P(TestDiffCalculusKz, diverge1)
{
...
TEST_P(TestDiffCalculusKz, diverge2)
{
...
TEST_P(TestDiffCalculusKz, curl1)
{
...
TEST_P(TestDiffCalculusKz, curl2)
{
...
TEST_P(TestDiffCalculusKz, identity_curl_grad_f0_eq_0)
{
...
TEST_P(TestDiffCalculusKz, identity_curl_grad_f3_eq_0)
{
...
TEST_P(TestDiffCalculusKz, identity_div_curl_f1_eq0)
{
...
TEST_P(TestDiffCalculusKz, identity_div_curl_f2_eq0)
{

	TOneForm f1(mesh);
	TCTwoForm f2(mesh);
	TCThreeForm f3a(mesh);
	TCThreeForm f3b(mesh);
