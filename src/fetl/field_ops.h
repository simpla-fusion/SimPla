...
template<int I, typename TL, typename TR, typename TM, typename ...TI> inline auto OpEval(Int2Type<CROSS>,
        Field<Geometry<TM, I>, TL> const &l, Field<Geometry<TM, I>, TR> const &r, TI ... s)
...
operator*(Field<Geometry<TG, IFORM>, TL> const & lhs, Field<Geometry<TG, IR>, TR> const & rhs)
...
template<typename TG, int IFORM, typename TL>
inline auto HodgeStar(Field<Geometry<TG, IFORM>, TL> const & f)
DECL_RET_TYPE(
...
template<typename TG, int IFORM, typename TL>
inline auto d(Field<Geometry<TG, IFORM>, TL> const & f)
DECL_RET_TYPE(
...
inline auto Wedge(Field<Geometry<TG, IFORM>, TL> const & lhs, Field<Geometry<TG, IR>, TR> const & rhs)
