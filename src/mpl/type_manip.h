...
struct Conversion<void, T>
{
	enum
	{
		exists = 0, exists2Way = 0, sameType = 0
	};
};
...
struct SuperSubclass
{
	enum
	{
		value = (::simpla::Conversion<const volatile U*, const volatile T*>::exists
				&& !::simpla::Conversion<const volatile T*, const volatile void*>::sameType)
	};
...
struct SuperSubclass<void, U>
{
	enum
	{
		value = (::simpla::Conversion<const volatile U*, const volatile void*>::exists
				&& !::simpla::Conversion<const volatile void*,
...
struct SuperSubclass<T, void>
{
	enum
	{
		value = (::simpla::Conversion<const volatile void*, const volatile T*>::exists
				&& !::simpla::Conversion<const volatile T*, const volatile void*>::sameType)
	};
...
struct SuperSubclassStrict
{
	enum
	{
		value = (::simpla::Conversion<const volatile U*, const volatile T*>::exists
				&& !::simpla::Conversion<const volatile T*, const volatile void*>::sameType
				&& !::simpla::Conversion<const volatile T*, const volatile U*>::sameType)
	};
...
struct SuperSubclassStrict<void, U>
{
	enum
	{
		value = (::simpla::Conversion<const volatile U*, const volatile void*>::exists
				&& !::simpla::Conversion<const volatile void*,
						const volatile void*>::sameType
				&& !::simpla::Conversion<const volatile void*, const volatile U*>::sameType)
	};
