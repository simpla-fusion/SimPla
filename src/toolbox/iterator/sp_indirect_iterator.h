...
#ifndef CORE_toolbox_ITERATOR_SP_INDIRECT_ITERATOR_H_
#define CORE_toolbox_ITERATOR_SP_INDIRECT_ITERATOR_H_
...
struct sp_indirect_range
{
    ...
    static bool is_splittable_in_proportion()
    {
...
#endif /* CORE_toolbox_ITERATOR_SP_INDIRECT_ITERATOR_H_ */
