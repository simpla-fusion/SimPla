...
#ifndef CORE_toolbox_ITERATOR_SP_NTUPLE_RANGE_H_
#define CORE_toolbox_ITERATOR_SP_NTUPLE_RANGE_H_
...
//	}
    ...
    {
        return value_in_range<DIMS...>(m_b_, m_e_, x);
...
#endif /* CORE_toolbox_ITERATOR_SP_NTUPLE_RANGE_H_ */
