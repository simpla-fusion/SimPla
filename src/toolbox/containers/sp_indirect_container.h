...
#ifndef CORE_toolbox_CONTAINERS_SP_INDIRECT_CONTAINER_H_
#define CORE_toolbox_CONTAINERS_SP_INDIRECT_CONTAINER_H_
...
#endif /* CORE_toolbox_CONTAINERS_SP_INDIRECT_CONTAINER_H_ */
