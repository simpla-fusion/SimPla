...
#ifndef CORE_toolbox_CONTAINERS_SP_HASH_CONTAINER_H_
#define CORE_toolbox_CONTAINERS_SP_HASH_CONTAINER_H_
...
#endif /* CORE_toolbox_CONTAINERS_SP_HASH_CONTAINER_H_ */
