...
//	}
	...
	typename mesh_type:: template field<EDGE, scalar_type> const& J_(Bool2Type<false>) const
	{
		return self_.J;
	}

	typename mesh_type:: template field<EDGE, scalar_type> const& J_(Bool2Type<true>) const
	{
		return dummy_J;
	}

	typename mesh_type:: template field<VERTEX, nTuple<3, scalar_type>> const& Jv_(Bool2Type<true>) const
	{
		return self_.J;
	}

	typename mesh_type:: template field<VERTEX, nTuple<3, scalar_type>> const& Jv_(Bool2Type<false>) const
	{
		return dummy_Jv;
	}
	void NextTimeStepZero_(Bool2Type<true>, typename mesh_type:: template field<EDGE, scalar_type> const & E,
	        typename mesh_type:: template field<FACE, scalar_type> const & B)
	{
	}
	void NextTimeStepZero_(Bool2Type<false>, typename mesh_type:: template field<EDGE, scalar_type> const & E,
	        typename mesh_type:: template field<FACE, scalar_type> const & B)
	{
		self_.NextTimeStepZero(E, B);
	}
	void NextTimeStepZero_(Bool2Type<true>,
	        typename mesh_type:: template field<VERTEX, nTuple<3, scalar_type>> const & E,
	        typename mesh_type:: template field<VERTEX, nTuple<3, scalar_type>> const & B)
	{
		self_.NextTimeStepZero(E, B);
	}
	void NextTimeStepZero_(Bool2Type<false>,
	        typename mesh_type:: template field<VERTEX, nTuple<3, scalar_type>> const & E,
	        typename mesh_type:: template field<VERTEX, nTuple<3, scalar_type>> const & B)
	{
	}

	void NextTimeStepHalf_(Bool2Type<false>, typename mesh_type:: template field<EDGE, scalar_type> const & E,
	        typename mesh_type:: template field<FACE, scalar_type> const & B)
	{
		self_.NextTimeStepHalf(E, B);
	}
	void NextTimeStepHalf_(Bool2Type<true>, typename mesh_type:: template field<EDGE, scalar_type> const & E,
	        typename mesh_type:: template field<FACE, scalar_type> const & B)
	{
	}
	void NextTimeStepHalf_(Bool2Type<false>,
	        typename mesh_type:: template field<VERTEX, nTuple<3, scalar_type>> const & E,
	        typename mesh_type:: template field<VERTEX, nTuple<3, scalar_type>> const & B)
	{
	}
	void NextTimeStepHalf_(Bool2Type<true>,
	        typename mesh_type:: template field<VERTEX, nTuple<3, scalar_type>> const & E,
	        typename mesh_type:: template field<VERTEX, nTuple<3, scalar_type>> const & B)
	{
		self_.NextTimeStepHalf(E, B);
