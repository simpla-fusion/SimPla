...
std::shared_ptr<
        ...
        UnorderedSet < typename Engine::Point_s,
...
{
typedef Particle <TDomain, Engine, UnorderedSet<typename Engine::Point_s,
        _impl::particle_hasher<TDomain, typename Engine::Point_s> >>
        particle_type;
...
struct KineticParticle : public Particle<TDomain, Engine>
{
