...
constexpr double SI_permittivity_of_free_space = 1.0
		/ (SI_speed_of_light * SI_speed_of_light * SI_permeability_of_free_space);

constexpr double SI_gravitational_constant = 6.67384e-11; /*1.2e-4*/

constexpr double SI_plank_constant = 6.62606957e-34;

constexpr double SI_plank_constant_bar = 1.054571726e-34;

constexpr double SI_elementary_charge = 1.60217656e-19; /*2.2e-8*/

constexpr double SI_electron_mass = 9.10938291e-31; /*4.4e-8*/
...
constexpr double SI_fine_structure_constant = 7.2973525698e-3; /*3.23-10*/

constexpr double SI_Rydberg_constant = 10973731.568539; /*5e-12*/

constexpr double SI_Avogadro_constant = 6.02214129e23; /*4.4e-8*/

constexpr double SI_Faraday_constant = 96485.3365; /*2.2e-10*/

constexpr double SI_Boltzmann_constant = 1.3806488e-23; /*9.1e-7*/

constexpr double SI_electron_volt = 1.602176565e-19; /*2.2e-8*/
