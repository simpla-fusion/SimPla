...
//    }
//}
//MC_HOST void spParallelMemcpy(void *dest, void const *src, int s)
//{
//    CUDA_CHECK_RETURN(cudaMemcpy(dest, src, s, cudaMemcpyDefault));
//}
//
//
//void spParallelMemcpyToSymbol(void *dest, void const *src, int s)
//{
//    CUDA_CHECK_RETURN(cudaMemcpyToSymbol(dest, src, s));
//
//}
//
//void spParallelMemset(void *dest, byte_type v, int s)
//{
