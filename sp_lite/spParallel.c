...
//
//    spParallelUpdateNdArrayHalo(buffer, 2, m_dims_, start, NULL, count, NULL, MPI_INT);
//
//
//    printf("\n"
//               "[%d/%d/%d] \t  %d,%d,%d,%d,%d \n"
...
int spParallelUpdateNdArrayHalo2(int num_of_buffer, void **buffers, const spDataType *data_desc, int ndims,
