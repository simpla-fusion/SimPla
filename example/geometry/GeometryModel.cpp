...
int main(int argc, char** argv) {
    auto t_surf = sg::ToroidalSurface::New(sg::Axis::New(), 1.0, 0.2);
    auto line = sg::Line::New(
        sg::Axis::New(point_type{0, 0, 0}, point_type{1, 0, 0}, point_type{0, 1, 0}, point_type{0, 0, 1}));
