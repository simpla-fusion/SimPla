...
int main(int argc, char **argv)
{
    ...
    simulation::Context ctx;
    {
        ...
        if (options["PML"])
        {
            ...
            ctx.add_domain_as<pml_type>(pml_mesh[0].get())->setup_center_domain(mesh_center->box()).deploy();
            ...
            ctx.add_domain_as<pml_type>(pml_mesh[1].get())->setup_center_domain(mesh_center->box()).deploy();
            ...
            if (dims[1] > 1 && gw[1] > 0)
            {
                ...
                ctx.add_domain_as<pml_type>(pml_mesh[2].get())->setup_center_domain(mesh_center->box()).deploy();
                ...
                ctx.add_domain_as<pml_type>(pml_mesh[3].get())->setup_center_domain(mesh_center->box()).deploy();
            ...
            if (dims[2] > 1 && gw[1] > 0)
            {
                ...
                ctx.add_domain_as<pml_type>(pml_mesh[4].get())->setup_center_domain(mesh_center->box()).deploy();
                ...
                ctx.add_domain_as<pml_type>(pml_mesh[5].get())->setup_center_domain(mesh_center->box()).deploy();
