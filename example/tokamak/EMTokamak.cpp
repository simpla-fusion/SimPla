...
int main(int argc, char **argv) {
    ...
    auto g_boundary = sg::MakeRevolution(tokamak->Boundary(), sp::TWOPI);
    auto d_limiter =
        scenario->NewDomain<domain::Maxwell<domain_type>>("Limiter", sg::MakeRevolution(tokamak->Limiter(), sp::TWOPI));
