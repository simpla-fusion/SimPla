...
ax.set_xticks(arange(0.5,6.6,1),minor=True)
ax.set_xticks(arange(0,6,1),minor=False)
ax.xaxis.grid(True,which='minor',color='r',linestyle='--')
ax.xaxis.grid(True,which='major',color='b',linestyle='-')
 
ax.set_yticks(arange(0.5,6.6,1),minor=True)
ax.set_yticks(arange(0,6,1),minor=False)
