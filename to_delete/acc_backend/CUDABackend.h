...
#ifndef SIMPLA_CUDABACKEND_H
#define SIMPLA_CUDABACKEND_H
...
#define SP_DEVICE_CALL(_CMD_)                                                                                          \
    {                                                                                                                  \
        auto __error_cod = (_CMD_);                                                                                    \
        if (SP_SUCCESS != print_device_error(__error_cod, __FILE__, __LINE__, __PRETTY_FUNCTION__, __STRING(_CMD_))) { \
            return SP_FAILED;                                                                                          \
        }                                                                                                              \
    }
//#define SP_DEVICE_CALL(_CMD_) {                                            \
