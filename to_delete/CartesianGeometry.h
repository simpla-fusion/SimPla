...
//    for (int i = 0; i < 3; ++i)
//    {
//        c_lower[i] = std::max(c_lower[i], std::Pack<0>(other)[i]);
//        c_upper[i] = std::min(c_upper[i], std::Pack<1>(other)[i]);
//
...
//            std::Pack<0>(res) = m_coords_lower_ - m_coarsest_cell_width_ * m_ghost_width_;
//            std::Pack<1>(res) = m_coords_upper_ + m_coarsest_cell_width_ * m_ghost_width_;;
//            break;
...
//            break;
//        case SP_ES_OWNED:
//            std::Pack<0>(res) = m_coords_lower_;
//            std::Pack<1>(res) = m_coords_upper_;
//            break;
...
//    {
//        return std::Pack<0>(m::point_global_to_local(inv_map(x), n_id));
//    }
//
//
//
