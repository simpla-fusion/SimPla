...
//struct field_type
//{
//    typedef field<ValueType, TM, std::integral_constant<int, IFORM>, Policies...> value_type_info;
//};
...
struct extent<Field<T ...>, M> : public int_const<traits::seq_get<M, extents<Field<T ...> > >::value> {};
